        ...
        <div className=''>
           ...
           <div className='mb-28'>
            ...
            <div className="card w-full bg-base-100 lg:px-96 gird justify-items-center">
                ...
                <input type="text" placeholder="Type here" className="input input-bordered w-full mb-3 lg:mt-12 mt-5" />
                ...
                <p>No Account <span className='mb-5 text-secondary'>Register Please</span></p>
