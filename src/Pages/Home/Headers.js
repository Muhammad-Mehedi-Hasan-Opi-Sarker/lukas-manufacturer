...
const Headers = () => {
    ...
    {user&& <li><Link to='/home' >Dhashboard</Link></li>}
    </>
    return (
            ...
            <div className="navbar bg-base-100">
                ...
                <div className="navbar-end">
                    <ul className='text-xl'>
                        <li>{ user? <button onClick={logout} className='btn btn-primary text-base-100'>{user.displayName}</button> : <Link to='/signin' >Login</Link> }</li>
                    </ul>
                </div>
            </div>
        </div>
